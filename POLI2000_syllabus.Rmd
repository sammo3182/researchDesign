...
dates$content[is.na(dates$content)] <- c("Being a Political Scientist", "Being Scientific", "How to Find Research Question", "Concepts", "Measurement", "Theory", "Experimental Logic and Design", "Principles of Case Study", "Case Study in Practice", "A Glance of Other Small-N Methods", "Understanding Large-N Analyses", "Professionalization", "Presentation", "Presentation")
...
# Requirements
I will base your grade for the course on your performance in the four areas below. For each component of the course grade, I assign a numerical score. I then calculate the course grade with the weighted average of the component scores. Scores of 90-100 correspond to A, 80-89 to B, etc., with pluses and minuses for the top and bottom third of each decile.
