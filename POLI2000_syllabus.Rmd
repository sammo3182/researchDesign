...
First, students are expected to understand the basic principles of building scientific researches and able to use them to evaluate the established or on-going projects in political science.
Second, students are expected to comprehend the common methods in political science research and understand how they can offer empirical evidence to test the theoretical inferences.
...
sheet <- select(sheet, -weekDay) %>%
  mutate(content = c("Van Evera 1997; Geddes 2010", 
  "Babbie 2012; Ragin&Amoroso 2010", "McKeown 1999; Perez&Tavits 2017",
  "Babbie 2012; Collier&Mahon 1993", "Collier&Levitsky 1997; Barnett&Duvall 2005",
  "Babbie 2012; Schedler 2012", "Adcock&Collier2001; Seawright&Collier 2014",
  "Van Evera 1997", "MIDTERM REVIEW", 
  "MIDTERM EXAM", "Przeworski&Teune 1970; Babbie 2012",
  "Bernstein et al. 2000; Gerring 2005", "Fearon 1991; Gerring 2010",
  "Babbie 2012; Mintz 2004", "Mintz et. al. 2006; Gerber&Green 2011",
  "Gerring 2004; McKeown 2004", "Przeworski&Teune 1970; Levy 2008",
  "Geddes 2010; Bennett&Elman 2007", "Van Evera 1997",
  "Babbie 2012; Munck 2004", "Capoccia&Kelemen 2007;Bennett 2008",
  "Babbie 2012; Tang et al. 2016", "Hafner-Burton&Montgomery 2006; King et al. 2013",
  "Babbie 2012; Van Evera 1997", "Presentation Videos"), 
  pre1 = NA, pre2 = NA)
...
The proposal is expected  1500 - 2500 words (excluding the title and reference pages) in double-spaced, 1-inch margins, and 12 font size.
...
```{r, results = "asis"}
bib[c("Collier1993", "Collier1997", "Barnett2005")]
```
...
```{r, results = "asis"}
bib[c("Adcock2001","Seawright2014", "Schedler2012")]
```
...
```{r, results = "asis"}
bib[c("Gerring2005", "Gerring2010", "Fearon1991", "Bernstein2000")]
```
...
```{r, results = "asis"}
bib[c("Capoccia2007", "Bennett2008", "Munck2004")]
```
...
```{r, results = "asis"}
bib[c("Tang2016", "Hafner-Burton2006", "King2013")]
```
