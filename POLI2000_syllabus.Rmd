...
dates$content[is.na(dates$content)] <- c("Being a Political Scientist", "Being Scientific", "Research Question", "Concepts", "Theory", "Measurement", "Design: Experiment", "Design: Singal Case Study", "Design: Small-N", "Design: Large-N", "Content Analysis", "Profession", "Presentation", "Presentation")
