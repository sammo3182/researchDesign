...
and fully interactions between the instructor and students.

There are three fundamental goals of this course. First, students are
expected to understand the basic principles of building scientific
researches and able to use them to evaluate the established or on-going
projects in political science. Second, students are expected to
comprehend the common methods in political science research and
understand how they can offer empirical evidence to test the theoretical
inferences. Third, by taking the course, students are expected to be
able to develop their own research designs following the principles of
...
I will take attendance at the begining of every class. Every attendence
is marked as one score. You are given three (free) absences (i.e.~I
don't need, nor do I want, an excuse) but any absences beyond that will
result in one score reduction per absence regardless of the excuse,
except for medical reasons. Further, sports, music, Greek and other
events are not ``excusable'' absences. You should use your free absences
for these events. The ratio of your attendence score to the total number
of the class minus 3 will determine how much you will get from the 10\%
attendence grade. Confused? Come see me sooner rather than later if you
need clarification of this policy.
...
from the third Monday, every first 20 minutes will be your show time.
The student who signed for that day will make a 10-min presentation
about the reading. The presentation should include three parts: a brief
summarising what the article is about and its relations with other
materials, which point in the article impresses you the most and why,
and at least one question you really want to know but the article does
not spell it out. I will evaluate your performance in each---especially
the latter two---aspects (see more details in the attached rubric).
Please cherish this chance to practice your presentation capability, and
...
\item
  ...
  journals of political science in this part and discuss how they relate
...
The proposal is expected 1500 - 2500 words (excluding the title and
reference pages) in double-spaced, 1-inch margins, and 12 font size. The
proposal will be evaluated based on each of the above parts and the
...
\def\labelenumi{\arabic{enumi}.}
\item
  You can earn 2 extra credits by using bibliography management software
...
\item
  ...
  the research paper.
\item
  You can get 1 extra credit by attending an academic workshop held by
  the Department of Political Science and send me a selfie at the
  workshop scene.
\end{enumerate}
...
Feasibility (5\%)\strut
\end{minipage} & \begin{minipage}[t]{0.76\columnwidth}\raggedright\strut
Is the research design a feasible one for a college student? What're the
