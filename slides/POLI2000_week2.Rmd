...
<div class="notes">
<span style="color:red">Agreement reality</span>: Those things we "know" as part and parcel of the culture we share with those around us (Babbie 2016, 7). 
</div>
...
* Why should a project be reproducable?
    + Transparency (?)
    + Future research (?)
...
* Dependent variable: *Disbelief* in meritocracy
