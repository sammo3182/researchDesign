...
## Concomitant variation (most similar system)
...
```{r}
text_tb <- data.frame(US = c("American continent", "Broad territory", "Anglo-Saxon", "Democracy", "Federal", "Parliamentary"), 
                      Canada = c("American continent", "Broad territory", "Anglo-Saxon", "Democracy", "Federal", "Presidential"))
...
* Control: Common systemic characteristics
* Explanatory: Differences
...
* Within, then cross-system
* Main, then secondary variables
* Stop: number of variables or degrees of freedom is exhausted