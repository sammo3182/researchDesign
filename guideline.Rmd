...
Our task is not to being expert on any of them but being exposed to all of them so that we know what we can do when we intend to do something.
...
Babbie briefly discusses about it and Adcock and Collier specify it in terms of political science.
...
* How do you choose from the four measure types (nominal, ordinal, interval, and ratio)? What is the assumption you've make when you choose one of them?
